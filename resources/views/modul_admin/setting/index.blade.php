            ...
            <div class="row">
                ...
                <div class="col-md-3 mb-2 mb-md-0">
                    <ul class="nav nav-pills flex-column mt-md-0 mt-1">
                        <li class="nav-item">
                            <a class="nav-link d-flex py-75 active" id="pill-general" data-toggle="pill"
                                href="#vertical-general" aria-expanded="true">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <div class="tab-content">
                                    {{-- Panel General --}}
                                    <div role="tabpanel" class="tab-pane active" id="vertical-general"
                                        aria-labelledby="pill-general" aria-expanded="true">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            ...
                                                            <input type="text" class="form-control" name="judul"
                                                                value="{{ $setpage->judul }}" placeholder="Judul Website"
                                                                required>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            ...
                                                            <input type="number" name="no_telp" class="form-control"
                                                                value="{{ $setpage->no_telp }}" placeholder="Nomor Telp">
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            ...
                                                            <input type="email" name="email"
                                                                class="form-control"value="{{ $setpage->email }}"
                                                                placeholder="Email">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            ...
                                                            <input type="file" name="img_hero" class="form-control"
                                                                placeholder="Username No Telp">
                                                            <small class="text-warning">Recomendes Image size 1200p x
                                                                400p</small>
                                                        </div>
                                                    </div>
                                                </div>
